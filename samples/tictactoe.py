...
class TicTacToe(Game):
    ...
    def evaluate_state(self, state):
        for i in range(4):
            ...
            if (
                rot_state[0][0] == rot_state[1][1] == rot_state[2][2] == 2
                or rot_state[0][0] == rot_state[0][1] == rot_state[0][2] == 2
                or rot_state[1][0] == rot_state[1][1] == rot_state[1][2] == 2
            ):
                return -1
        if np.count_nonzero(rot_state == 0) == 0:
            return 0
        return None
